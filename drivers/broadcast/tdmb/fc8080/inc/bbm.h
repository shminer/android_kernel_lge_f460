...
extern fci_s32 bbm_com_bulk_read(
		HANDLE handle, fci_u16 addr, fci_u8 *data, fci_u16 size);
extern fci_s32 bbm_com_data(
		HANDLE handle, fci_u16 addr, fci_u8 *data, fci_u32 size);
...
extern fci_s32 bbm_com_bulk_write(
		HANDLE handle, fci_u16 addr, fci_u8 *data, fci_u16 size);
extern fci_s32 bbm_com_tuner_read(
		HANDLE handle, fci_u8 addr, fci_u8 addr_len,
		fci_u8 *buffer, fci_u8 len);
extern fci_s32 bbm_com_tuner_write(
		HANDLE handle, fci_u8 addr, fci_u8 addr_len,
		fci_u8 *buffer, fci_u8 len);
extern fci_s32 bbm_com_tuner_set_freq(HANDLE handle, fci_u32 freq);
extern fci_s32 bbm_com_tuner_select(
		HANDLE handle, fci_u32 product, fci_u32 band);
extern fci_s32 bbm_com_tuner_get_rssi(HANDLE handle, fci_s32 *rssi);
extern fci_s32 bbm_com_scan_status(HANDLE handle);
extern fci_s32 bbm_com_channel_select(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id);
extern fci_s32 bbm_com_video_select(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id, fci_u8 cdi_id);
extern fci_s32 bbm_com_audio_select(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id);
extern fci_s32 bbm_com_data_select(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id);
extern fci_s32 bbm_com_channel_deselect(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id);
extern fci_s32 bbm_com_video_deselect(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id, fci_u8 cdi_id);
extern fci_s32 bbm_com_audio_deselect(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id);
extern fci_s32 bbm_com_data_deselect(
		HANDLE handle, fci_u8 subch_id, fci_u8 buf_id);
extern fci_s32 bbm_com_hostif_select(HANDLE handle, fci_u8 hostif);
extern fci_s32 bbm_com_hostif_deselect(HANDLE handle);
extern fci_s32 bbm_com_fic_callback_register(
		fci_u32 userdata, fci_s32 (*callback)(fci_u32 userdata,
		fci_u8 *data, fci_s32 length));
extern fci_s32 bbm_com_msc_callback_register(
		fci_u32 userdata, fci_s32 (*callback)(fci_u32 userdata,
