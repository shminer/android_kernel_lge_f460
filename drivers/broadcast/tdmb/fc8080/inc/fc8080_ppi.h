...
extern fci_s32 fc8080_ppi_bulkread(
		HANDLE handle, fci_u16 addr, fci_u8 *data, fci_u16 length);
...
extern fci_s32 fc8080_ppi_bulkwrite(
		HANDLE handle, fci_u16 addr, fci_u8 *data, fci_u16 length);
extern fci_s32 fc8080_ppi_dataread(
		HANDLE handle, fci_u16 addr, fci_u8 *data, fci_u32 length);
