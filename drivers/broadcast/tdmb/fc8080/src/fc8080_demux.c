...
**	  2.   Variables
*============================================================*/
static int (*pFicCallback)(fci_u32 userdata, fci_u8 *data, int length);
static int (*pMscCallback)(
	fci_u32 userdata, fci_u8 subChId, fci_u8 *data, int length);
static fci_u32 gFicUserData, gMscUserData;

static fci_u8 sync_error_cnt;
...
int fc8080_demux_fic_callback_register(
	fci_u32 userdata,
	int (*callback)(fci_u32 userdata, fci_u8 *data, int length))
{
...
int fc8080_demux_msc_callback_register(
	fci_u32 userdata,
	int (*callback)(fci_u32 userdata, fci_u8 subChId,
	fci_u8 *data, int length))
{
