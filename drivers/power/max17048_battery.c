...
int max17048_set_rcomp_by_temperature(struct i2c_client *client)
{
	...
	int temp;
	int rc;
#if !defined(CONFIG_SMB349_CHARGER) && !defined(CONFIG_LGE_PM_CHARGING_BQ24296_CHARGER)
...
#elif defined(CONFIG_LGE_PM_CHARGING_BQ24296_CHARGER)
...
#ifdef CONFIG_LGE_PM_BATTERY_ID_CHECKER
#ifndef CONFIG_LGE_PM_BATTERY_CUT_OFF_3_4V
