...
#if (HZ != 1000)
#error The Kernel timer is not configured at 1ms. \
Please update TIMER_INCR to generate a proper 5ms timer. \
#endif
...
static void VibeOSKernelLinuxStartTimer(void)
{
	...
	if (res != 0)
	{
		DbgOut((KERN_INFO "VibeOSKernelLinuxStartTimer: "
					"down_interruptible interrupted by a sig.\n"));
	}
}
