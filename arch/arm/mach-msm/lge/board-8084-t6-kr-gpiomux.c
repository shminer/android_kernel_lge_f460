...
static struct msm_gpiomux_config mdm_configs[] __initdata = {
	...
	/* MDM2AP_VDD_MIN*/
	{
		.gpio = 115,
		.settings = {
			[GPIOMUX_SUSPENDED] = &mdm2ap_vdd_min,
		}
	},
#endif
};
...
static struct msm_gpiomux_config msm_vibrator_configs[] __initdata = {
	{
		.gpio = 48,
		.settings = {
...
static struct gpiomux_setting pcie0_reset_n_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
...
static struct msm_gpiomux_config wlan_wake_msm_configs[] __initdata = {
	{
		.gpio = 121,			/* interrupt pin for WLAN Wake MSM, OOB , do not use now*/
		.settings = {
...
static struct msm_gpiomux_config pcie0_wake_n_configs[] __initdata = {
	{
		.gpio = 69,			/* interrupt pin for WLAN Wake MSM, PME , use now*/
		.settings = {
...
static struct msm_gpiomux_config pcie0_reset_n_configs[] __initdata = {
	{
		.gpio = 70,
		.settings = {
			[GPIOMUX_ACTIVE]    = &pcie0_reset_n_cfg,
			[GPIOMUX_SUSPENDED] = &pcie0_reset_n_cfg,
		},
	},
};
/*                                                                 */
...
static struct msm_gpiomux_config apq8084_qua_mi2s_configs[] __initdata = {
	{
		.gpio = 91,
		.settings = {
...
static struct gpiomux_setting headset_active_cfg_gpio5 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir  = GPIOMUX_IN,
...
static struct msm_gpiomux_config headset_configs_gpio5[]  = {
	{
		.gpio = 5,
		.settings = {
			[GPIOMUX_ACTIVE]    = &headset_active_cfg_gpio5,
		},
	},
};
#endif
...
#ifdef CONFIG_LGE_PM
static struct gpiomux_setting gpio_unused_suspended_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config apq8084_batt_id_configs[] __initdata = {
	{
		.gpio	   = 13,  /* BATT_ID */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_unused_suspended_config,
		},
	},
	{
		.gpio	   = 14,  /* BATT_ID_PULL_UP */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_unused_suspended_config,
		},
	},
};
static struct msm_gpiomux_config apq8084_unused_pin_configs[] __initdata = {
	{
		.gpio	   = 29,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_unused_suspended_config,
...
void __init t6_rev_c_init_gpiomux(void)
{
#if defined(CONFIG_SWITCH_MAX1462X) || defined(CONFIG_INPUT_MAX14688)
...
void __init t6_rev_1_0_init_gpiomux(void)
{
#if defined(CONFIG_SWITCH_MAX1462X) || defined(CONFIG_INPUT_MAX14688)
	msm_gpiomux_install(headset_configs, ARRAY_SIZE(headset_configs));
	msm_gpiomux_install(headset_configs_gpio5, ARRAY_SIZE(headset_configs_gpio5));
#endif
};
...
#ifdef CONFIG_SND_SOC_CS35L32
		msm_gpiomux_install(apq8084_qua_mi2s_configs,
				ARRAY_SIZE(apq8084_qua_mi2s_configs));
#endif
...
#ifdef CONFIG_LGE_PM
	msm_gpiomux_install(apq8084_batt_id_configs,
			ARRAY_SIZE(apq8084_batt_id_configs));
	msm_gpiomux_install(apq8084_unused_pin_configs,
			ARRAY_SIZE(apq8084_unused_pin_configs));
#endif

	msm_gpiomux_install(msm_vibrator_configs,
			ARRAY_SIZE(msm_vibrator_configs));
