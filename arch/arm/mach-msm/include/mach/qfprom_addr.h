#ifndef __MACH_QFPROM_ADDR_8084_H__
#define __MACH_QFPROM_ADDR_8084_H__

#define SEC_PATH "/dev/block/platform/msm_sdcc.1/by-name/sec"
...
#endif // __MACH_QFPROM_ADDR_8084_H__
